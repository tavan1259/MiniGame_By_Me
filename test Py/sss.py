...
Button_Exit_menu = Button(450, 695, But_Exit_Menu, "Exit_menu", "Exit_menu")
Button_Play_menu = Button(450, 495, But_Play_Menu, "Exit_menu", "Exit_menu")
...
while Menu:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN and  Button_Play_menu._is_hovered() :
            if Button_Play_menu.goods_type == "Exit_menu":
                ...
                while running:
                    ...
                    elif YOU_HIT_ract.colliderect(BUY_HIT_ract) :
                    ...
                    if YOU_HIT_ract.colliderect(ORDER_HIT_ract): #เมื่อชนกับฮิตบล็อค
                        ...
                        if len(InStock) > 0 :
                            if (keys[pygame.K_SPACE] and stat == 10) and keys != keys[pygame.K_LEFT] : #เมื่อกด Spacebar
                                man.right = False
                                man.left = False
                                man.walkCount = 0
                    ...
                    if stat == 6 :
                        ...
                        if money >= 1000:
                            ...
                            while Win:
                                for event in pygame.event.get():
                                    print(event)
                                    if event.type == pygame.MOUSEBUTTONDOWN and  Button_ReturnToMenu_menu._is_hovered() :
                        ...
                        elif (HP == 0) or (money == 0 and len(InStock)  == 0) :
                            sound_Over.play()
                            while Lose:
                                for event in pygame.event.get():
                                    print(event)
        ...
        if event.type == pygame.MOUSEBUTTONDOWN and  Button_Show_menu._is_hovered() :
            if Button_Show_menu.goods_type == "Exit_menu":
                Menu = False
                while How:
                    for event in pygame.event.get():
                        if event.type == pygame.MOUSEBUTTONDOWN and  Button_ReturnToMenu_menu2._is_hovered() :
        ...
        if event.type == pygame.MOUSEBUTTONDOWN and  Button_Exit_menu._is_hovered() :
